...
public class Constant {
    public static final String ROOT_PATH = Environment.getExternalStorageDirectory() + "/" + eeui.getApplication().getPackageName()+ "/recorder";
    ...
    public static final int MEDIA_PLAY_START = 160000;
    public static final int MEDIA_PLAY_COMPLETION = 160001;
    public static final int MEDIA_PLAY_ERROR = 160002;
